...
with colors.palette; ''
  ...
  general {
    ...
    # col.group_border_active=0xff${base04}
    # col.group_border=0xff${base02}
  ...
  # Program bindings
  bind = SUPER,Return,exec,alacritty -e zsh
  bind = CONTROL SHIFT,Return,exec,alacritty --working-directory=$(pwd) -e zsh
